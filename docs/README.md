# Repository Document Layout

This folder keeps the thesis materials organized by purpose.

- `thesis/`: thesis chapter drafts and future final manuscript files.
...
- `../archives/`: original compressed reference materials.
